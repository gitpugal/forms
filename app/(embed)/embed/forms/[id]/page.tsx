  ...
  return (
    <>
      {isFetching ? (
        ...
        <div className={`${curForm?.theme == "dark" && "dark"} w-full h-fit `}>
          {curForm?.closed ? (
            <div
            ...
            <div
              className={`w-full  mx-auto  dark:bg-black/85 dark:text-white  p-10  overflow-y-scroll bg-red-200 no-scrollbar`}
              style={
                !curTheme
